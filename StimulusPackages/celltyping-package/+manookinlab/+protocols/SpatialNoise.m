...
%                 disp(obj.time_multiple)
		...
		if strcmp(obj.onlineAnalysis,'extracellular')
            ...
            if ~strcmp(obj.onlineAnalysis, 'none') && ~obj.isMeaRig
                gridSizePix = obj.rig.getDevice('Stage').um2pix(obj.gridSize);
                obj.showFigure('manookinlab.figures.SpatialNoiseFigure', ...
                    obj.rig.getDevice(obj.amp), 'recordingType', obj.onlineAnalysis, ...
                    'stixelSize', obj.gridSize, ...
                    'numXChecks', ceil(obj.canvasSize(1)/gridSizePix), ...
                    'numYChecks', ceil(obj.canvasSize(2)/gridSizePix), ...
